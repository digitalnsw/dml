<template>
  ...
  <div id="cards">
    <div class="row">
      ...
      <div v-for="(card_obj, index) in this.$store.state.cardsList.filter(isVisible)" :key="index" class="col-md-4 col-xs-6">
        <div class="card">
...
export default {
  ...
  destroyed() {
    ...
    const answersObject = arrayToObject(this.$store.state.cardsList)
